...
-   ArcGIS Pro, QGIS, Global Mapper, ENVI, FME,
...
-   Python, R, SQL
-   VEXCEL UltraMap (Imagery), Reigl RiProcess (LiDAR), Applanix POSPac (GPS)
-   Adobe Suite (Illustrator, Photoshop), Blender
...
[Click Here to download the PDF](20250408_OECM_Candidate_Identification_in_Howe_Sound_Biosphere_Region_MaxLorsignol.pdf){download="Max Lorsignol's Resume"}
