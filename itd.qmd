...
format: html
editor: visual
image: "images/itd_front_image.png"
...
setwd("~/Desktop/GitHub/maxlorsignol.github.io/data")
wd <- "~/Desktop/GitHub/maxlorsignol.github.io/data"   # create a variable string working directory
```

## Visualize

Below is a interactive visualization of one of the extracted plots of a forest. We will be detecting each one of these trees using two different tree detection methods.

```{r 3d visual, warning=FALSE, message=FALSE, echo=FALSE, results='hide', eval=FALSE}
#| execute: true
#| eval: true
#| warning: false
#| message: false
...
plot_1 <- readLAS("~/Desktop/GitHub/maxlorsignol.github.io/data/Plot_1.las")
...
```{r li2012 visual, warning=FALSE, message=FALSE, echo=FALSE, results='hide', eval=FALSE}
#| execute: true
#| eval: true
#| warning: false
#| message: false
...
```{r dalp2016 visual, warning=FALSE, message=FALSE, echo=FALSE, results='hide', eval=FALSE}
#| execute: true
#| eval: true
#| warning: false
#| message: false
...
Visually comparing the outputs of the Li et al. (2012) and Dalponte & Coomes (2016) methods shows how algorithm design influences crown delineation:

The Li (2012) method may detect more smaller crowns and emphasize point-cloud structure. The Dalponte (2016) method tends to produce smoother, CHM-driven crown shapes and is sensitive to CHM resolution and treetop detection parameters.

These differences have downstream implications for metrics such as tree density, crown area, and estimates of forest structure, and should be considered when choosing an ITD algorithm for a particular forest type or management application.
